...
contract IDOPool is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        developer = 0xE2c40d6602199Bf27a051e714aA904a3ccF75352; // developer address
        commission = 400; // 0.04% en wei
    ...
    function refund() external {
        ...
        require(totalInvestedETH > 1, "The IDO pool did not reach soft cap.");
    ...
    function refundTokens() external onlyOwner {
        require(block.timestamp > timestamps.endTimestamp, "The IDO pool has not ended.");
        require(totalInvestedETH > 1, "The IDO pool reach soft cap.");
